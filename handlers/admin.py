...
async def check_bot_status(update: Update, context: CallbackContext) -> None:
...
async def clear_logs(update: Update, context: CallbackContext) -> None:
...
async def delete_old_files(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(f"🗑️ Deleted {deleted_count} old files.")